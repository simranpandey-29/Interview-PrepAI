          ...
          <div className="flex flex-col md:flex-row items-center">
            ...
            <div className="w-full md:w-1/2">
              <p className="text-[17px] text-gray-900 mr-0 md:mr-20 mb-6">
                ...
                Practice with role-specific questions, unlock deeper explanations, 
                strengthen your concepts, and stay organized. From preparation to 
                confidence, we’ve got your interview journey covered.
              </p>
